...
ActiveRecord::Schema[7.0].define(version: 2025_12_26_070000) do
  ...
  create_table "diary_edit_histories", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "diary_id", null: false
    t.text "content"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["diary_id"], name: "index_diary_edit_histories_on_diary_id"
  end
  ...
  add_foreign_key "diary_edit_histories", "diaries"
